...
\begin{figure}[!h]
    ...
    \caption{
        ...
        However, after only 100 generations of natural selection for adaptive movement preferences, scenario 3 populations had a higher intake than ostensibly locally `optimal' movement.
        ...
        \textbf{(C)} Movement implementations strongly influenced individuals' associations (based on proximity), with step-selection movement leading to many times more associations than random or locally optimal movement.
    }
