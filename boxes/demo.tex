...
\paragraph{Random Walks and Locally Optimal Movement}
...
\paragraph{Movement as Step-selection}
...
\paragraph{Adding Detail to Step-selection-based Decision Making}
...
\paragraph{Step-selection Based on Two Cues}
...
\paragraph{Step-selection Based on Three Cues}
