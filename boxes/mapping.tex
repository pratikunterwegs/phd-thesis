...
% \begin{addmargin}[-2.0cm]{0cm}
	...
	% \addcontentsline{toc}{chapter}{\tocEntry{\color{darkgray}{\adftripleflourishleft~~Box 1: Mapping Animal Movement in \textit{R}}}}%
	\medskip
	...
	To whom is this effort owed, and by whom, and how can the additional work required be prevented from becoming a gatekeeping mechanism? %{\color{red}(1), (2)}? 
	These are issues that the ecology and evolution community will have to address.
% \end{addmargin}
\afterpage{\nopagecolor}
