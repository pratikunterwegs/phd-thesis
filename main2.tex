\documentclass[twoside,b5paper]{tufte-book}

\hypersetup{colorlinks}% uncomment this line if you prefer colored hyperlinks (e.g., for onscreen viewing)

%%
% Book metadata
\title{Animal\\Movement\\Strategies}
\author[Pratik Rajan Gupte]{Pratik Rajan Gupte}
...
\nohyphenation
What can be achieved when one
doesn't listen to supervisors.
\end{doublespace}
\vfill
\vfill
...
\part{High Resolution Animal Tracking}

% \include{chapters/preprocessing_header}

% \include{chapters/preprocessing_main}

\part{Individual-Based Modelling in Animal Movement Ecology}
