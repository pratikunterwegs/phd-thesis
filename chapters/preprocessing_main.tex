...
% \newrefcontext[sorting=nyt]
    ...
    \graffito{
        The `sf' package is a massive improvement on previous spatial-data handling tools in R (e.g. `sp', `ppp'). More generally, R's spatial data ecosystem has undergone some substantial changes over the past 7 years that I've been using it.
    }
    ...
    \printbibliography[title=Literature~Cited,heading=subbibliography]
\end{refsection}
