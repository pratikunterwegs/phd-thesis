...
\newrefcontext[sorting=ynt]
    ...
    \graffito{
        Methods from \citep{fleming2014a} are technically very advanced, and that puts them beyond the reach of many animal ecologists.
    }
    ...
    \graffito{
        Neither \citep{barraquand2008} nor \citep{bijleveld2016} had reproducible code --- I cannot really be sure how my implementation corresponds to theirs.
    }
    ...
    \graffito{
        When writing this, I wasn't fully convinced that ATLAS systems solve for X and Y coordinates independently. The assumption of independence underlies the formula for `SD' --- but \citep{weiser2016} does not make it perfectly clear whether it is correct.
    }
    ...
    \graffito{
        \citealp{bjorneraas2010}'s 2010 paper is surprisingly not as well known as it should be.
    }
    ...
    % \end{lst{\color{red} Listing}}
    \graffito{
        This issue was especially evident in WATLAS tracking data from 2018. ATLAS positioning errors are an interesting combination of
        failures of the physical tracking device, as well as failures of the maximum likelihood localisation algorithm.
    }
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.95\textwidth]{figures/preprocessing/fig_04.png}
        \caption{
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.95\textwidth]{figures/preprocessing/fig_05.png}
        \caption{
    ...
    \graffito{
        These and similar data are further analysed in \citep{lourie2021}.
    }
    ...
    \graffito{
        I also had the opportunity to test the residence patch method on pike tracked using YAPS \citep{baktoft2017}, and found it worked very well.
    }
