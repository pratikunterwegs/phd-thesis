...
\graffito{
    Methods from \citet{fleming2014} are very advanced, and that puts them beyond the reach of many animal ecologists.
}
...
\graffito{
    Regardless of the level of automation there is no replacement for human supervision at certain stages of data cleaning, which inherently makes it a subjective process. This both normal and desirable.
}
...
% \end{linenomath*}
\graffito{
    Median smoothing is a classic method \citep{tukey1977}, that has found applications across fields, including for example, in recovering corrupted digital images.
}
