...
\centering
\includegraphics[width=0.9\textwidth]{figures/holeybirdsfig_02.png}
\caption{
...
\begin{figure}%[\sidecaptionrelwidth][!t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/holeybirdsfig_01.png}
...
\begin{figure}%[\sidecaptionrelwidth][!t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/holeybirdsfig_03.png}
    % width=8.7cm,height=8.7cm
    \caption{
...
\centering
\includegraphics[width=0.9\textwidth]{figures/holeybirdsfig_04.png}
% width=8.7cm,height=8.7cm
\caption{
