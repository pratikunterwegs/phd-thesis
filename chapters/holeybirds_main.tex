...
With between-patch movements as steps, we performed species- and moult-status specific step-selection analysis (SSA) to determine how these predictors affected habitat selection (see \textit{Supplementary Information}) \cite{avgar2016}.
...
We fit GAMs with species-specific smooths to examine the effect of wing gap size on the availability of shelter in individual birds' areas of prolonged residence (``residence patches'') \cite{gupte2022d}.
