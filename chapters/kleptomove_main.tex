...
To keep the model realistic, we based it on the foraging behavior of shorebirds such as oystercatchers (\textit{Haematopus} spp.), which are extensively studied in the context of foraging competition, both empirically \citep[e.g.][]{vahl2005b, vahl2005,vahl2007, rutten2010, rutten2010a}, and using individual-based models \citep[reviewed in][]{stillman2010}.
...
Individuals select a destination cell, after assessing potential destinations based on available cues, similar to approaches used previously \citep{getz2015,getz2016,white2018,scherer2020,netz2021}.
...
A weighted lottery (with weights proportional to lifetime resource intake) selects a parent for each offspring in the subsequent generation \citep[see e.g.][]{tania2012,netz2021}.
...
Orienting movement towards resources \citep[][\textit{where to move}]{nathan2008} can be a challenge in a system with low densities of discrete prey-items, because the local prey \textit{density} may provide very limited information about local \textit{productivity}.
...
This selects for movement strategies incorporating the presence and condition of competitors into individual movement decisions, or \textit{social movement strategies} \citep[see an example in \citealt{guttal2010}; see][for social information]{dall2005}.
...
Such differences may help reduce competition as individuals make subtly different movement decisions when presented with the same cues \citep[][see also \citealt{wolf2012}]{laskowski2013}.
...
In scenario 2, this departure from predictions is driven by the contrasting movement rules of foragers, which evolve to \textit{avoid} handlers as well as non-handlers, both of which might be kleptoparasites (cryptic interference; seen in interference-sensitive shorebirds \citealt{bijleveld2012}).
...
Animal tracking technology is only on the cusp of allowing us to track entire populations (though small ones), and classifying their behaviour at the fine temporal scales of animal decision-making (Nathan et al. in press. \textit{Science}; see e.g. \citealt{lieber2021, sankey2021}).
...
Instead, experimental approaches may reveal movement strategies that reduce competitive interactions \citep{vahl2005,vahl2005b,rutten2010, bijleveld2012}.
...
Animal movement ecology takes an explicitly individual-based approach, centred around individual decisions \citep{nathan2008}.
...
Modelling mechanistic movement decisions has substantial consequences for ecological outcomes \citep[e.g.][]{mueller2011,white2018,scherer2020}, yet few individual-based models in animal movement are mechanistic \citep[see review in:][]{deangelis2019}, and even fewer models include evolutionary dynamics \citep[but see][]{getz2015,getz2016,netz2021}. 
Yet explicitly modelling both ecological interactions and evolutionary dynamics, as we do here, can reveal surprising outcomes ranging from innovative predator-prey strategies \citep{netz2021} to sympatric speciation \citep{getz2016}.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/kleptomove/fig_02.png}
    \caption{
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/kleptomove/fig_03.png}
    \caption{
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/kleptomove/fig_04.png}
    \caption{
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/kleptomove/fig_05.png}
    \caption{
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/kleptomove/fig_06.png}
    \caption{
