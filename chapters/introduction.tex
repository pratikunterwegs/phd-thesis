...
We propose models that \textit{work forwards from plausible mechanisms to potential emergent outcomes} (Fig.~\ref{fig:intro_concepts}).
...
% our Interlude~\ref{box:demo} to run for some thousands of generations (say, 3,000), then altering the spatial structure, and running the model for a few thousand generations more (e.g. initially having 30 patches of 15 items each, and then 90 patches, of 5 items each).
