...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/fig_eco_evo_general.png}
    \caption{
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/fig_social_outcomes.png}
    \caption{
...
\begin{figure*}[p]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/fig_networks_disease.png}
    % width=8.7cm
    \caption{
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/fig_evo_strategy_default.png}
    % width=8.7cm
    \caption{
