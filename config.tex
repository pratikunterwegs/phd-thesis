...
\PassOptionsToPackage{
  ...
  style=classicthesis,
  parts=true
  %classicthesis % classicthesis, arsclassica
}{classicthesis}
...
\PassOptionsToPackage{%
  ...
  eprint=false,
  % style=science,%
  style=authoryear,%oxyear, % Author 1999, 2010
  % bibstyle=authoryear,
...
% no volume, pages, or issue number
...
\hypersetup{%
  ...
  urlcolor=CTurl, linkcolor=black, citecolor=black, %pagecolor=RoyalBlue,%
