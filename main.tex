...
\titleformat{\chapter}[display]%
    ...
    {\relax}{\mbox{}\oldmarginpar{\bfseries\rmfamily\scshape\small{\color{Maroon}~Chapter~\vspace*{.5\baselineskip}}{\displayfont\chapterNumber{\color{Maroon}\thechapter}}}}{0pt}%
    {\raggedright\bfseries\color{Maroon}\large\rmfamily\scshape}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{\thesection}{1em}{\color{Maroon}\raggedright\rmfamily\bfseries\scshape}
