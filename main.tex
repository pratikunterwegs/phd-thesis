...
\newfontfamily{\headerfont}{Tiempos Headline}
...
% fix section format
\titleformat{\section}
    {\relax}{\underline{\thesection}}{1em}{\Large\color{Maroon}\raggedright\headerfont\bfseries}%[\vspace*{.2\baselineskip}\titlerule]
