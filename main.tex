...
\setmainfont[Numbers={Proportional,Uppercase}]{Source Serif Pro}

% \defaultfontfeatures{
%   RawFeature={+axis={wght=100}},
%   UprightFont = {Source Serif 4 Variable}
% }
% \setmainfont[
%   Path={}
%   % BoldFeatures={RawFeature={+axis={wght=700}}},
%   % ItalicFeatures={RawFeature={+axis={wght=300}}},
%   % UprightFeatures={RawFeature={+axis={wght=450}}}
% ]{SourceSerif4Variable-Roman.otf}
% % \setmainfont[Numbers={Proportional,Uppercase}]{Vollkorn}
% % \setmainfont[
% %     ItalicFont=SourceSerif4Variable-Italic.otf,
% %     BoldFont=SourceSerif4Variable-Roman.otf,
% %     BoldItalicFont=SourceSerif4Variable-Italic.otf,
...
\titleformat{\part}[display]
        ...
        {\huge\rmfamily\scshape\bfseries}[\bigskip\normalfont\normalsize\color{Black}\begin{quote}\ctparttext@print\end{quote}]
        
% fix chapter heading format
\titleformat{\chapter}[display]%
    % \setbox0=\hbox{\chapterNumber\thechapter\hspace{10pt}\vline\ }%
    {\relax}{\mbox{}\oldmarginpar{\bfseries\rmfamily{\tiny{Chapter}}~\displayfont\chapterNumber\thechapter}}{0pt}%
    {\raggedright\large\rmfamily\scshape}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{\thesection}{1em}{\rmfamily\bfseries\scshape}
...
\renewcommand{\chaptermark}[1]{\markboth{\color{gray}\small\scshape\rmfamily{\thechapter}}{\color{gray}\small\scshape\rmfamily{#1}}}
...
In the second part of this thesis, I probe the evolution of animal movement, and show how evolutionary shifts in movement strategies can be very rapid.}
