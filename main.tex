...
\setsansfont{DM Sans}%[Extension = .ttf]%, 
...
\titleformat{\part}[display]
        {\ct@altfont\centering\LARGE\displayfont}%
        {\thispagestyle{empty}\displayfont\partname~\MakeTextUppercase{\thepart}}{1em}%
        {\huge\displayfont}[\bigskip\normalfont\normalsize\color{Black}\begin{quote}\ctparttext@print\end{quote}]
...
\renewcommand{\thepart}{\thepart}%
\renewcommand{\cftpartpresnum}{\normalfont}%  \MakeTextLowercase
% chapters in toc
