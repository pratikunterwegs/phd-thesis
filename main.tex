...
\setmainfont{Source Serif Pro}%[Extension = .ttf, UprightFont = *-Light,BoldFont = *-Regular]
...
\titleformat{\chapter}[display]%
    ...
    {\raggedright\huge\rmfamily\scshape}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{\thesection}{1em}{\rmfamily\bfseries\scshape\large}

% fix section format
\titleformat{\subsection}
    {\relax}{\thesubsection}{1em}{\rmfamily\scshape\itshape}
