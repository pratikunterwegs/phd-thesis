...
\titleformat{\part}[display]
        ...
        {\thispagestyle{empty}\scshape\bfseries\rmfamily\partname~\MakeTextUppercase{\thepart}}{1em}%
...
% fix section format
\titleformat{\section}
    {\relax}{\thesection}{1em}{\rmfamily\bfseries\large}
