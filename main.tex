...
\addbibresource{chapters/hillybirds.bib}
...
\titleformat{\chapter}[display]%
    ...
    {\relax}{\mbox{}\oldmarginpar{\itseries\bfseries\rmfamily{\tiny{Chapter}}\chapterNumber\thechapter}}{0pt}%
    {\raggedright\huge\sffamily}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{\thesection}{1em}{\rmfamily\bfseries}
...
\titleformat{\paragraph}
    {\relax}{\theparagraph}{1em}{\rmfamily\small\MakeTextUppercase}
...
\cleardoublepage \include{chapters/holeybirds}
