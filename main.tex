...
\setlength{\textheight}{1.03\textheight}
% \usepackage[b5paper, total={170mm, 240mm}]{geometry}
...
\renewcommand{\chapterNumber}{%
  \displayfont\color{Maroon}\fontsize{60}{20} \bfseries}\par
...
\newenvironment{interludeenv}{
  ...
  {}
  {0pt}
  {\raggedright\color{Maroon}\displayfont\itshape\bfseries{\huge{Interlude~{\theinterludes}\\}\large}}[\normalsize\vspace*{.2\baselineskip}\titlerule]
}
...
\newenvironment{bibenv}{
  ...
  {}
  {0pt}
  {\raggedright\color{Maroon}\displayfont\itshape\bfseries{\huge{Bibliography\\}\large}}[\normalsize\vspace*{.2\baselineskip}\titlerule]
}
...
\def\blx@initsep{%
	...
	{%
		...
		{}
		{\leavevmode\marginline{\color{Maroon}\underline{\bfseries\headerfont\huge\printfield{sortinit}}}}%
		\fi
...
\titleformat{\chapter}[display]%
    {\relax}
    {\mbox{}\oldmarginpar{\centering\displayfont\itshape\small{\color{Maroon}~Chapter~\vspace*{.5\baselineskip}}{\displayfont\chapterNumber{\color{Maroon}\thechapter}}}}
    {0pt}%
    {\raggedright\itshape\bfseries\displayfont\color{Maroon}\Huge}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{{\thesection}}{1em}{\Large\color{Maroon}\raggedright\headerfont\bfseries}[\color{Maroon}\normalsize\vspace*{.1\baselineskip}\titlerule]
