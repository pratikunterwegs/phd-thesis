...
\documentclass[twoside,openright,titlepage,numbers=noenddot,%1headlines,
              ...
              BCOR=5mm,paper=b5,fontsize=9pt,dvipsnames,toc=indentunnumbered
              ]{scrbook}
...
\newfontfamily{\headerfont}{IBM Plex Serif}
...
\renewcommand{\chapterNumber}{%
  \displayfont\color{Maroon}\fontsize{70}{20} \bfseries}\par
...
\newenvironment{interludeenv}{
  ...
  {}
  {0pt}
  {\raggedright\color{Maroon}\headerfont\itshape\bfseries{\huge{Interlude~{\theinterludes}\\}\large}}[\normalsize\vspace*{.2\baselineskip}\titlerule]
}
...
\newenvironment{bibenv}{
  ...
  {}
  {0pt}
  {\raggedright\color{Maroon}\headerfont\itshape\bfseries{\huge{Bibliography\\}\large}}[\normalsize\vspace*{.2\baselineskip}\titlerule]
}
...
\def\blx@initsep{%
	...
	{%
		...
		{}
		{\leavevmode\marginline{\color{Maroon}\bfseries\headerfont\huge\printfield{sortinit}}}%
		\fi
...
\titleformat{\part}[display]
        ...
        {\thispagestyle{empty}\color{Maroon}\displayfont\scshape\partname~\MakeTextUppercase\displayfont{\thepart}}{1em}%
...
\titleformat{\chapter}[display]%
    {\relax}
    {\mbox{}\oldmarginpar{\centering\headerfont\itshape\small{\color{Maroon}~Chapter~\vspace*{.5\baselineskip}}{\displayfont\chapterNumber{\color{Maroon}\thechapter}}}}
    {0pt}%
    {\raggedright\itshape\bfseries\headerfont\color{Maroon}\Huge}[\normalsize\vspace*{.2\baselineskip}\titlerule]%

% fix section format
\titleformat{\section}
    {\relax}{\underline{\thesection}}{1em}{\Large\color{Maroon}\raggedright\headerfont\itshape\bfseries}%[\vspace*{.2\baselineskip}\titlerule]

% fix section format
\titleformat{\subsection}
    {\relax}{\thesubsection}{1em}{\raggedright\headerfont\itshape}
...
\usepackage[skins,float,floatplacement=p]{tcolorbox}
% \usepackage{lipsum}
