...
\setlength{\textheight}{1.035\textheight}
...
\renewcommand{\chapterNumber}{%
  \displayfont\color{black}\fontsize{60}{20} \bfseries}\par
...
\titleformat{\chapter}[display]%
    {\relax}
    {\mbox{}\oldmarginpar{\centering\displayfont\itshape\small{\color{black}~Chapter~\vspace*{.5\baselineskip}}{\displayfont\chapterNumber{\color{black}\thechapter}}}}
    {0pt}%
