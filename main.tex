...
\renewcommand{\chaptermark}[1]{\markboth{\small\sffamily\MakeUppercase{#1}}{\small\sffamily\MakeUppercase{#1}}}
...
\cleardoublepage \include{chapters/preprocessing_header} % \include{chapters/preprocessing_main}
...
\cleardoublepage \include{chapters/hillybirds}
...
\cleardoublepage \include{chapters/kleptomove_header} \include{chapters/kleptomove_main}
