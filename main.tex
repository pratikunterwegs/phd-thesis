...
% \setsansfont{IBM Plex Sans Condensed}[Extension = .ttf, 
%     UprightFont = *-Regular,BoldFont = *-Medium, ItalicFont = *-Italic]
...
\titleformat{\part}[display]
        ...
        {\color{maroon}\scshape\huge\rmfamily}[\bigskip\normalfont\normalsize\color{Black}\begin{quote}\ctparttext@print\end{quote}]
        
% fix chapter heading format
\titleformat{\chapter}[display]%
    % \setbox0=\hbox{\chapterNumber\thechapter\hspace{10pt}\vline\ }%
    {\relax}{\mbox{}\oldmarginpar{\bfseries\rmfamily{\tiny{Chapter}}\chapterNumber\thechapter}}{0pt}%
...
\titleformat{\subsection}
    {\relax}{\thesubsection}{1em}{\rmfamily\itshape}
...
% \clearpage \include{boxes/mapping}
...
\clearpage
\include{chapters/kleptomove_header} 
% \include{chapters/kleptomove_main}

\clearpage
\include{chapters/pathomove_header}
